...
class DataIngestion:
    ...
    def extract_tgz_file(self, tgz_file_path:str):
        try:
            ...
            logging.info(" tgz extraction completed")
    ...
    def split_data_as_train_test_data(self, ):
        try:
            ...
            for train_index, test_index in split.split(housing_df, housing_df["income_cat"]):#returns training data and testing data indices
                strat_train_set = housing_df.loc[train_index].drop(["income_cat"], axis=1)
                start_test_set = housing_df.loc[test_index].drop(["income_cat"], axis=1)
            ...
            if strat_test_set is not None:
                os.makedirs(self.data_ingestion_config.ingested_test_dir, exists_ok=True)
            ...
            logging.ingo(f"Data Ingestion artifact:[{data_ingestion_artifact}]")
